...
- ✅ **Character Encoding**: Comprehensive support for Latin-based encodings (priority focus)
  - UTF-8, UTF-16 (BE/LE)
...
- ✅ **Content-ID**: Support for inline images and CID links
- ✅ **Streaming**: Efficient parsing of large emails (100MB+)
- ✅ **Standards Compliant**: Follows RFC 2822, RFC 2045-2049
...
The API is similar but follows Go conventions:
...
if err == nil {
    ...
    fmt.Println(mail.From[0])
}
```

## Known Limitations

- HTML to text conversion not yet implemented (use external library)
- Text to HTML conversion not yet implemented (simple version available)
- Japanese encodings (JIS, ISO-2022-JP) limited support
- No streaming parse events (use callback-free design instead)

## Contributing

Contributions welcome! Priority areas:

1. HTML to text conversion (integrate golang.org/x/net/html)
2. Additional charset support (CJK languages)
3. Format=flowed text support
